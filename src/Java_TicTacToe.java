...
public class Java_TicTacToe extends javax.swing.JFrame {
    ...
    private int xCount = 0;//biến đếm số lần thắng của X
    private int oCount = 0;//biến đếm số lần thắng của O
    ...
    private void jCBxSelectActionPerformed(java.awt.event.ActionEvent evt) {                                           
        int x = RANDOM.nextInt(3), y = RANDOM.nextInt(3);
        jlblPlayer1.setText("Computer:");
        jlblPlayer2.setText("Human:");
